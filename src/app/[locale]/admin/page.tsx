  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        ...
        <button onClick={() => signOut({ callbackUrl: '/' })} className="text-sm font-medium px-4 py-2 bg-[var(--sections)] text-[var(--foreground)] border border-[var(--border)] rounded-lg hover:bg-red-50 hover:text-red-600 transition-colors shadow-sm">
           Log Out
        </button>
      </div>
